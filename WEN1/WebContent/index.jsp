...
<html> 
	<head>
		...
		<title>포커게임 입니다.</title>
	</head>	
	<script type="text/javascript">		// 자바스크립트 문
		state = 0;
		function changeImage1() {			// 
			if(state==0) {
				state = 1;
				document.getElementById('image_2').src = './image/0.jpg';		// image_2 의 src값에 카드 뒷면 이미지를 넣겠다.
				document.getElementById('image_3').src = './image/0.jpg';		// image_3 의 src값에 카드 뒷면 이미지를 넣겠다.
			} 
		}
